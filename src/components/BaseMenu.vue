...
.menu {
    ...
    &__back>* {
        ...
        &:hover {
            background-color: desaturate($additionColor, 10%);
            cursor: pointer;
            background-image: $base64bg;
        }
    }
